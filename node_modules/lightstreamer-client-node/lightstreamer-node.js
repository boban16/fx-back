...
var Constants = /*@__PURE__*/(function() {
   ...
   */
    ...
    BUILD: '1791',
    LIBRARY_VERSION: '8.0.5',
    LIBRARY_NAME: 'nodejs',
    LIBRARY_TAG: 'nodejs_client',
    LS_CID: 'tqGko0tg4pkpW3DAK3R4hwLri8LBV8k',
    ...
    onProg: function(prog) {
        ...
        if (this.currentProg == null) {
            ...
            if (this.currentProg > sessionProg) {
                ...
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(418),prog,sessionProg);
            ...
            if (this.currentProg != prog) {
                ...
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(419),prog,this.currentProg);
                this.sessionHandler.onPROGCounterMismatch();
            } else if (prog != sessionProg) {
                //>>excludeStart("debugExclude", pragmas.debugExclude);
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(420),prog,sessionProg);
                this.sessionHandler.onPROGCounterMismatch();
            }
        }
    },
