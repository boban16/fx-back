...
var Constants = /*@__PURE__*/(function() {
   ...
   */
    ...
    LS_CID: 'tqGko0tg4pkpW3DAK3Q4hwLri8LBV7i',
...
var actionsLogger = LoggerManager.getLoggerProxy(Constants.ACTIONS);
  ...
  Bean.prototype = {
    ...
    /*public*/ simpleSetter: function(prop,_value) {
      ...
      //actionsLogger.logDebug(LoggerManager.resolve(367),this.parent,prop,this.getValueForLog(propName));
    ...
    /*protected*/ heavySetter: function(prop,_value) {
      ...
      if(_value != this[propName]) {//obviously notify changes only if the value is actually changed
        ...
        //actionsLogger.logInfo(LoggerManager.resolve(368),prop,this.getValueForLog(propName));
    ...
    /*private*/ broadcastSetting: function(prop) { 
      var propName = this.getPropName(prop);
      //sharingLogger.logDebug(LoggerManager.resolve(369),prop,this.getValueForLog(propName));
    ...
    notifyChange: function(prop) {
      ...
      if (this.parent && this.parent.notifyOptionChange) {
        ...
        //actionsLogger.logDebug(LoggerManager.resolve(370),prop,this.getValueForLog(propName));
  ...
  var ASSERT = {
    ...
    compareArrays: function(arr1,expected,sameOrder) {
      if (arr1.length != expected.length) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(371),arr1,expected);
        return false;
      }
      ...
      if (!sameOrder) {
        ...
        for (var i=0; i<expected.length; i++) {
          if (!genMap[expected[i]]) {
            logger.logError(LoggerManager.resolve(372),expected[i]);
            this.failInternal();
            return false;
          } else {
            genMap[expected[i]]++;
        ...
        for (var i in genMap) {
          if (genMap[i] == 1) {
            logger.logError(LoggerManager.resolve(373),genMap[i]);
            this.failInternal();
            return false;
          }
        }
        ...
        for (var i=0; i<arr1.length; i++) {
          if(arr1[i] != expected[i]) {
            logger.logError(LoggerManager.resolve(374), arr1[i], expected[i]);
            this.failInternal();
            return false;
          }
        }
    ...
    verifyNotNull: function(val1) {
      if (val1 === null) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(375),val1);
        return false;
      }
      return true;
    },
    ...
    verifyDiffValue: function(val1,val2,strict) {
      ...
      if (!ok) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(377),val1,val2);
        return false;
      }
      return true;
    },
     ...
     */
    fail: function() {
      logger.logError(LoggerManager.resolve(380));
      this.failInternal();
      return false;
    },
    ...
    verify: function(obj,method,param,res,expectingException,compareFun) {
      ...
      if (!ok) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(381),what,"for",method,param,res,exc);
        return false;
      }
...
var protocolLogger = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  ...
  var RequestsHelper = {
    ...
    /*public*/ getPushCommand: function(
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(sessionId)) {
          protocolLogger.logError(LoggerManager.resolve(382));
        }
      //>>excludeEnd("debugExclude");
        ...
        protocolLogger.logDebug(LoggerManager.resolve(383),res);
        ...
        protocolLogger.logDebug(LoggerManager.resolve(384),lsUrl);
    ...
    getRecoveryCommand: function(pushPhase, sessionId, policyBean, reconnectionCause, delay, askDomain, sessionRecoveryProg) {
        ...
        protocolLogger.logDebug(LoggerManager.resolve(385), LSContextParams);
    ...
    /*public*/ getForceRebindParams: function(rebindCause,_delay) {
      ...
      protocolLogger.logDebug(LoggerManager.resolve(387));
...
var simple = CallDefinition.simple;
  ...
  NewEngineHandler.prototype = {
    ...
    setEngineId: function(id) {
      sharingLogger$1.logInfo(LoggerManager.resolve(388), this.engineType, id);
      this.engineId = id;
    },
...
//calls from pushpage handler
    ...
    onEngineDeath: function(suiciding, noHopeToAttachToAnotherEngine) {
        sharingLogger$1.logInfo(LoggerManager.resolve(389), this.engineId + " is dead");
        if (this.client) {
            this.sessionEnd(-1);
...
var subscriptionsLogger = LoggerManager.getLoggerProxy(Constants.SUBSCRIPTIONS);
  ...
  SubscriptionsHandler.prototype = {
    ...
    /*public*/ addATable: function(tableIn) {
      ...
      subscriptionsLogger.logInfo(LoggerManager.resolve(390),tableIn);
    ...
    /*public*/ removeATable: function(subscriptionOut) {
      ...
      subscriptionsLogger.logInfo(LoggerManager.resolve(391),subscriptionOut);
      ...
      //>>excludeEnd("debugExclude");
        ...
        if (this.promisesFromId[tableId]) {
          ...
          this.enqueueToPromise(tableId, function(tableNumber) {
            ...
            subscriptionsLogger.logDebug(LoggerManager.resolve(394),subscriptionChanging);
    ...
    /*private*/ passTableToEngine: function(tableIn) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(395));

      var tableNumPromise = this.eh.subscribeTable(tableIn.getRequestParams());
      if (this.promisesFromId[tableId]) {
          subscriptionsLogger.logDebug(LoggerManager.resolve(396), tableId);
      } else {
          //>>excludeStart("debugExclude", pragmas.debugExclude);  
      ...
      this.enqueueToPromise(tableId, function(tableNumber) {
        ...
        subscriptionsLogger.logDebug(LoggerManager.resolve(398),tableIn);
    ...
    enqueueToPromise: function(tableId, action) {
        ...
        promise["then"](function(tableNumber) {
            ...
            if (that.promisesFromId[tableId] != promise) {
                // overridden (session changed?)
                subscriptionsLogger.logDebug(LoggerManager.resolve(400), tableId);
                return;
            }
            delete(that.promisesFromId[tableId]);
            delete(that.promiseQueuesFromId[tableId]);
    ...
    /*public*/ handleAllWaitingTables: function() {
      subscriptionsLogger.logDebug(LoggerManager.resolve(401));
    ...
    //>>excludeEnd("debugExclude");
      subscriptionsLogger.logDebug(LoggerManager.resolve(402),_table);
    ...
    /*public*/ pauseAllTables: function() {
      subscriptionsLogger.logDebug(LoggerManager.resolve(403));
    ...
    callTableByNum: function(tableNum, method) {
        ...
        if (_id) {
            ...
            if (this.promisesFromId[_id]) {
                ...
                // subscriptionsLogger.logDebug(LoggerManager.resolve(406),tableInfo);
                if (tableInfo) {
                    method.apply(tableInfo);
                }
            }
                        ...
                        (function(tableId) {
                            that.enqueueToPromise(tableId, function(tableNumber) {
                                if (tableNumber == tableNum) {
                                    subscriptionsLogger.logDebug(LoggerManager.resolve(408),tableNum);
            ...
            subscriptionsLogger.logDebug(LoggerManager.resolve(409),n);
        }
    },
  ...
  EventDispatcher.prototype = {
      ...
      dispatchToOneListenerExecution: function(evt,params,listener,forced) {
        if (listener && listener.handler[evt] && (forced || listener.listening)) {
          try {
            ...
            //actionsLogger.logError(LoggerManager.resolve(410),evt,_e);
          }
        }
      },
      ...
      dispatchEvent: function(evt,params) {
        /*if (actionsLogger.isDebugLogEnabled()) {
          actionsLogger.logDebug(LoggerManager.resolve(411),evt);
        }*/
...
var protocolLogger$1 = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  ...
  PushEvents.prototype = {
    ...
    changeSession: function(session) {
      protocolLogger$1.logDebug(LoggerManager.resolve(412),session);
...
//      }*/
      ...
      if (protocolLogger$1.isDebugLogEnabled()) {
        protocolLogger$1.logDebug(LoggerManager.resolve(413),_ok);
      }
    ...
    processCountableNotification: function() {
        ...
        protocolLogger$1.logDebug(LoggerManager.resolve(414),sessionProg);
        if (this.currentProg != null) {
            //>>excludeStart("debugExclude", pragmas.debugExclude);
            if(!ASSERT.verifyOk((this.currentProg <= sessionProg))) {
              protocolLogger$1.logError(LoggerManager.resolve(415),this.currentProg);
            }
            //>>excludeEnd("debugExclude");
            this.currentProg++;
            if (this.currentProg <= sessionProg) {
                // already seen: to be skipped
                protocolLogger$1.logDebug(LoggerManager.resolve(416),this.currentProg);
                return false;
            } else {
                ...
                if(!ASSERT.verifyValue(this.currentProg,sessionProg)) {
                  protocolLogger$1.logError(LoggerManager.resolve(417),this.currentProg);
                }
                //>>excludeEnd("debugExclude");
                return true;
            }
    ...
    onProg: function(prog, capturedMessages) {
        ...
        if (this.currentProg == null) {
            ...
            if (this.currentProg > sessionProg) {
                ...
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(418),prog,sessionProg,capturedMessages);
            ...
            if (this.currentProg != prog) {
                ...
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(419),prog,this.currentProg,capturedMessages);
                this.sessionHandler.onPROGCounterMismatch();
            } else if (prog != sessionProg) {
                //>>excludeStart("debugExclude", pragmas.debugExclude);
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(420),prog,sessionProg,capturedMessages);
                this.sessionHandler.onPROGCounterMismatch();
            }
        }
    },
    ...
    onMessageErrorEvent: function(_code, num, messageCode, msg, isReqerr) {
      ...
      if(!ASSERT.verifyValue(messageCode.substring(0, 3),"MSG")) {
        protocolLogger$1.logError(LoggerManager.resolve(421),messageCode);
      }
      //>>excludeEnd("debugExclude");
    ...
    onControlEvent: function(flag, phase, tableCode, its, flds,kPos,cPos) {
      ...
      if (flag == 4) {
        ...
        //?
        protocolLogger$1.logDebug(LoggerManager.resolve(422),flag);
      }
  ...
  PushPageCollectionHandler.prototype = {
    ...
    checkConnectionPool: function(onlyMeCount) {
      ...
      if (status && status.getNumberOfConnectionsToServer(this.engine.sessionHandler.getPushServerAddress()) > onlyMeCount) {
        sharingLogger$2.logWarn(LoggerManager.resolve(423));
      }
    },
    ...
    onNewPushPage: function(ppId,pp) {
      ...
      sharingLogger$2.logDebug(LoggerManager.resolve(424),this);
    ...
    onPushPageLost: function(ppId) {
      sharingLogger$2.logDebug(LoggerManager.resolve(425),this,ppId);
    ...
    /*public*/ getPushPageHandler: function(pageNum) {
      if (!this.pushPages[pageNum]) {
        sharingLogger$2.logDebug(LoggerManager.resolve(427));
        return null;
      }
    ...
    /*public*/ handleTable: function(ppId,body) {
      ...
      if (!pageH || !this.engine.isSessionOpenOrRecovering()) {
        ...
        ASSERT.fail();
        //>>excludeEnd("debugExclude");
        sharingLogger$2.logError(LoggerManager.resolve(428),this,ppId);
        return;
      }
      ...
      sharingLogger$2.logDebug(LoggerManager.resolve(429));
  ...
  var MadTester = {
    ...
    /*public*/ canMakeRequest: function() {
      if (lastTime == 0) {
        ...
        sessionLogger.logError(LoggerManager.resolve(430));
        madLimit = 0;
        return false;
      }
...
var sessionLogger$1 = LoggerManager.getLoggerProxy(Constants.SESSION);
  ...
  function WebSocketConnection(wsSession) {
     ...
     if (streamLogger.isDebugLogEnabled()) {
         streamLogger.logDebug(LoggerManager.resolve(431), this.objectId);
     }
     this.isOpen=false;
     this.exePhase=null;
     this.openPhase=null;
  ...
  WebSocketConnection.prototype = {
    ...
    _close: function() {
      ...
      streamLogger.logDebug(LoggerManager.resolve(432));
      ...
      if (this.webSocketInstance) {
        try {
          ...
          streamLogger.logDebug(LoggerManager.resolve(433),__e);
        }
      }
    ...
    openSocket: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      if (this.isOpen) {
        streamLogger.logError(LoggerManager.resolve(434));
      } else if(disabled) {
        return false;
      }
      ...
      try {
        ...
        streamLogger.logDebug(LoggerManager.resolve(435),_e);
        return false;
        //SECURITY_ERR
    ...
    openWSTimeout: function(ph) {
      if (ph == this.openPhase && this.webSocketInstance && !this.openEventFired) {
        try {
          sessionLogger$1.logDebug(LoggerManager.resolve(436));
          this.wsSession.policyBean.increaseConnectTimeout();

          this.webSocketInstance.close(1000);
        } catch(_e) {
          streamLogger.logDebug(LoggerManager.resolve(437));
        }
      }
    },
    ...
    _load: function(request,phase) {
      if (this.isOpen) {
        streamLogger.logError(LoggerManager.resolve(438));
        return null;
      ...
      streamLogger.logDebug(LoggerManager.resolve(439),request.getUrl());
    ...
    //>>excludeStart("debugExclude", pragmas.debugExclude);
      if (!ASSERT.verifyOk(this.serverInUse)) {
        streamLogger.logError(LoggerManager.resolve(440));
        return false;
      }
    //>>excludeEnd("debugExclude");
    ...
    _send: function(req,ph) {
      ...
      if (streamLogger.isDebugLogEnabled()) {
          streamLogger.logDebug(LoggerManager.resolve(441), this.objectId, req.getFile(), req.getData());
      }

      try {
        this.webSocketInstance.send(req.getFile() + "\r\n" + req.getData());
      } catch(_e) {
        streamLogger.logError(LoggerManager.resolve(442),_e);
        //INVALID_STATE_ERR
    ...
    //>>excludeStart("debugExclude", pragmas.debugExclude);
      if (!ASSERT.verifyOk(res !== null)) {
        streamLogger.logError(LoggerManager.resolve(443),phase);
      }
    //>>excludeEnd("debugExclude");
      if (res) {
        this.isOpen = true;
...
///////////////////////////EVENTS
    ...
    */
    ...
    /*private*/ onPartialResponse: function(evt,phase,responseCallback) {
      ...
      if (streamLogger.isDebugLogEnabled()) {
          streamLogger.logDebug(LoggerManager.resolve(444), this.objectId, evt.data);
      }
    ...
    /*private*/ onErrorResponse: function(phase,errorCallback) {
      ...
      streamLogger.logError(LoggerManager.resolve(445), this.objectId);
    ...
    /*private*/ onOpenEvent: function(phase,req) {
      ...
      //this.openEvent = true;
      streamLogger.logDebug(LoggerManager.resolve(446));
    ...
    /*private*/ onCloseResponse: function(closeEv,phase,connectionEndCallback,errorCallback) {
      ...
      streamLogger.logDebug(LoggerManager.resolve(447),closeCode,this.openEvent);
...
/////////////////////////////////////EVENTS END
    ...
    /*public*/ setDefaultSessionId: function(defaultSessionId) {
        if (streamLogger.isDebugLogEnabled()) {
            streamLogger.logDebug(LoggerManager.resolve(448), defaultSessionId + " on WS connection oid=" + this.objectId);
        }
...
var _OFF = 1;
  ...
  var Session = function(isPolling,forced,handler,handlerPhase,originalSession,skipCors,sessionRecovery,mpnManager) {
    ...
    if (sessionLogger$2.isDebugLogEnabled()) {
        sessionLogger$2.logDebug(LoggerManager.resolve(449), "oid=" + this.objectId);
    }
    ...
    if (originalSession) {
      ...
      sessionLogger$2.logDebug(LoggerManager.resolve(450), this.dataNotificationCount);
  ...
  Session.prototype = {
      ...
      /*private*/ reset: function() {
        if (sessionLogger$2.isDebugLogEnabled()) {            
            sessionLogger$2.logDebug(LoggerManager.resolve(451), this.objectId);
        }
        this.bindCount = 0;
...
///////////////////////////////////phase handling
      ...
      /*private*/ changePhaseType: function(newType) {
        if (sessionLogger$2.isDebugLogEnabled()) {
            sessionLogger$2.logDebug(LoggerManager.resolve(452), this.objectId, statusStrings[this.phase], "->", statusStrings[newType]);
        }
...
//////////////////////////////////external calls
      /*public*/ createSession: function(oldSessionId,reconnectionCause,serverBusy) {
        ...
        if (openOnServer == OPEN_ON_SERVER) {
          sessionLogger$2.logDebug(LoggerManager.resolve(454),this);
          this.closeSession("new."+(reconnectionCause||""),OPEN_ON_SERVER,RECOVERY_SCHEDULED);
        }

        sessionLogger$2.logInfo(LoggerManager.resolve(455),this);
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase == PAUSE || this.phase == FIRST_PAUSE || this.phase == _OFF)) {
          sessionLogger$2.logError(LoggerManager.resolve(456));
        }
      //>>excludeEnd("debugExclude");
        ...
        if (this.isPolling) {
          sessionLogger$2.logDebug(LoggerManager.resolve(457),this);
        } else {
          sessionLogger$2.logInfo(LoggerManager.resolve(458),this);
        }
      ...
      /*public*/ requestSwitch: function(newHPhase,switchCause,forced) {
        ...
        sessionLogger$2.logDebug(LoggerManager.resolve(459),this);
        ...
        if (this.phase == CREATING || this.phase == SLEEP || this.phase == _OFF) { //Session Machine: during these statuses we do not have a session id
           ...
           */
          sessionLogger$2.logError(LoggerManager.resolve(460));
      ...
      sessionLogger$2.logDebug(LoggerManager.resolve(461),this);

      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase != CREATING && this.phase != SLEEP && this.phase != _OFF)) {
          sessionLogger$2.logError(LoggerManager.resolve(462));
        }
      //>>excludeEnd("debugExclude");
      ...
      /*public*/ closeSession: function(closeReason,alreadyClosedOnServer,noRecoveryScheduled) {
        sessionLogger$2.logInfo(LoggerManager.resolve(463),this,closeReason);
      ...
      /*public*/ shutdown: function(justSleep) {
        ...
        sessionLogger$2.logDebug(LoggerManager.resolve(464),this);
      },
      ...
      /*private*/ doPause: function(serverSentPause) {
        ...
        if (this.phase != FIRST_PAUSE && pauseToUse && pauseToUse > 0) {
          sessionLogger$2.logDebug(LoggerManager.resolve(465));
...
/////////////////////////////////////////EVENTS
      ...
      /*private*/ onTimeout: function(timeoutType, ph,usedTimeout,coreCause) {
        ...
        if (sessionLogger$2.isDebugLogEnabled()) {
            sessionLogger$2.logDebug(LoggerManager.resolve(466), timeoutType, statusStrings[this.phase], 
                    "sid", this.sessionId,
                    "cause=", coreCause,
        ...
        if (this.phase == CREATING) {
          ...
          if (this.recoveryBean.isRecovery() && timeLeftMs > 0) {
               ...
               */
              if (sessionLogger$2.isDebugLogEnabled()) {
                  sessionLogger$2.logDebug(LoggerManager.resolve(467), timeLeftMs);
              }
          ...
          if (this.slowRequired || this.switchRequired) {
              ...
              if (this.preparingRecovery) {
                  ...
                  sessionLogger$2.logDebug(LoggerManager.resolve(471));
          ...
          sessionLogger$2.logWarn(LoggerManager.resolve(472),this);
        }
      ...
      /*protected*/ onErrorEvent: function(reason, args) {
        ...
        var timeLeftMs = this.recoveryBean.timeLeftMs(this.policyBean.sessionRecoveryTimeout);
        if (sessionLogger$2.isDebugLogEnabled()) {
            sessionLogger$2.logDebug(LoggerManager.resolve(473), statusStrings[this.phase], "reason=" + reason, 
                    "sid=" + this.sessionId,
                    "timeLeft=" + timeLeftMs,
        ...
        if (this.phase == RECEIVING || this.phase == _STALLED ||this.phase == STALLING ||this.phase == BINDING || this.phase == PAUSE) {
          ...
          if (this.recoveryBean.isRecovery() && timeLeftMs > 0 && ! closedOnServer) {
            ...
            sessionLogger$2.logDebug(LoggerManager.resolve(477));
            ...
            this.handler.createMachine(this.handlerPhase,this.switchCause+".error",this.switchForced);
              ...
              sessionLogger$2.logDebug(LoggerManager.resolve(478), cause);
              this.closeSession(reason,closedOnServer,RECOVERY_SCHEDULED);
              //now is SLEEPing
      ...
      /*private*/ onEvent: function() {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$2.logError(LoggerManager.resolve(480),this);
        }
...
////////////////////////////////////////////////////////actions
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase == _OFF || this.phase == SLEEP)) {
          sessionLogger$2.logError(LoggerManager.resolve(481));
        }
      //>>excludeEnd("debugExclude");
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase == PAUSE || this.phase == FIRST_PAUSE)) {
          sessionLogger$2.logError(LoggerManager.resolve(482),this);
        }
      //>>excludeEnd("debugExclude");
      ...
      /*protected*/ launchTimeout: function(timeoutType, triggerAfter,timeoutCause) {
           ...
           */
        if (sessionLogger$2.isDebugLogEnabled()) {        
            sessionLogger$2.logDebug(LoggerManager.resolve(483), triggerAfter, timeoutType);
        }
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyValue(this.phase,CREATED)) {
          sessionLogger$2.logError(LoggerManager.resolve(484));
        }
      //>>excludeEnd("debugExclude");
        this.launchTimeout("stalledTimeout", this.policyBean.stalledTimeout);  //we won't reconnect if this executes, so no need to add a cause
      },
...
////////////////////////////////////////////////////////timeouts      
      ...
      /*private*/ calculateReconnectTimeout: function() {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$2.logError(LoggerManager.resolve(485),this);
          this.reconnectTimeout = null;
        }
...
///////////////////////////////////////////////SlowingEvents
      ...
      /*public*/ onSynchOk: function() {
        ...
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(486));
        }
...
///////////////////////////////////////////////PushEvents
      ...
      onServerSentBandwidth: function(maxBandwidth) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(487),maxBandwidth);
        }
      ...
      onOKReceived: function(newSession,controlLink,requestLimitLength,keepaliveIntervalDefault) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(490));
        }
        ...
        if (this.phase == CREATING) {
          //New session!
            if (this.sessionId != null && this.sessionId != newSession) {
                ...
                sessionLogger$2.logInfo(LoggerManager.resolve(491), newSession, this.sessionId);
                this.reset();
            }
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          if (!ASSERT.verifyValue(this.sessionId,newSession)) {
            sessionLogger$2.logError(LoggerManager.resolve(492));
          }
        //>>excludeEnd("debugExclude");
      ...
      /*public*/ onLoopReceived: function(serverSentPause) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(494));
        }
	...
	forwardREQERR: function(errorCode, errorMsg, listenerCallback) {
        if (errorCode == 20) { // sync error
            ...
            if (protocolLogger$2.isWarnLogEnabled()) {
                protocolLogger$2.logWarn(LoggerManager.resolve(495), errorCode, errorMsg);
            }
        }
	},
    ...
    forwardERROR: function(errorCode, errorMsg) {
      ...
      /*public*/ onEnd: function(message) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(496),message);
        }
...
///////////////////////////////////////////////CONTROL      
      ...
      /*private*/ sendDestroySession: function(reason) { 
        sessionLogger$2.logInfo(LoggerManager.resolve(499),this);
        ...
        var requestListener = {
                ...
                onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                    sessionLogger$2.logError(LoggerManager.resolve(500) + errorCode + " " + errorMsg + " - The error will be silently ignored.");
                }
        };
      ...
      changeBandwidth: function() {
        ...
        var requestListener = {
                ...
                onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                    sessionLogger$2.logError(LoggerManager.resolve(501) + printObj(query) + " caused the error: ", errorCode, errorMsg);
                }
        };
...
var streamLogger$1 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  function XSXHRConnection() {
     ...
     if (streamLogger$1.isDebugLogEnabled()) {
         streamLogger$1.logDebug(LoggerManager.resolve(502), this.objectId);
     }
     this.isOpen=false;
  ...
  XSXHRConnection.prototype = {
    ...
    /*public*/ _close: function() {
      ...
      if (streamLogger$1.isDebugLogEnabled()) {          
          streamLogger$1.logDebug(LoggerManager.resolve(503), this.objectId);
      }
      ...
      if (this.xhrInstance) {
        try {
          ...
          streamLogger$1.logDebug(LoggerManager.resolve(504));
        }
      }
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      if (streamLogger$1.isDebugLogEnabled()) {
          streamLogger$1.logDebug(LoggerManager.resolve(505), this.objectId, request.getFile(), request.getData());
      }
      ...
      try {
        ...
        streamLogger$1.logError(LoggerManager.resolve(506), this.objectId,_e);
        return false;
      }
    ...
    /*private*/ onPartialResponse: function(phase,responseCallback,connectionEndCallback,errorCallback) {
      ...
      if (this.isHttpStatusOk() && responseCallback) {
        ...
        if (streamLogger$1.isDebugLogEnabled()) {
            if (newData) {                
                streamLogger$1.logDebug(LoggerManager.resolve(507), this.objectId, newData);
            }
        }
      ...
      if (this.xhrInstance.readyState == 4) {
        if (!this.isHttpStatusOk()) {
          if (this.status0Disabled) {
            if (errorCallback) {
              if (streamLogger$1.isDebugLogEnabled) {
                  streamLogger$1.logDebug(LoggerManager.resolve(508), this.objectId);
              }
        ...
        if (streamLogger$1.isDebugLogEnabled) {
            streamLogger$1.logDebug(LoggerManager.resolve(509), this.objectId);
        }
    ...
    /*private*/ isHttpStatusOk: function() {
      try {
        ...
        streamLogger$1.logDebug(LoggerManager.resolve(510), this.objectId,_e);
        return false;
      }
    }
  };
...
// var LICENSE_ERR = "LS_window.alert('License not valid for this Client version');";
  ...
  IEXSXHRConnection.prototype = {
    ...
    /*public*/ _close: function() {
      ...
      streamLogger$2.logDebug(LoggerManager.resolve(511));
      ...
      if (this.xDomainReqInstance) {
        try {
          ...
          streamLogger$2.logDebug(LoggerManager.resolve(512));
        }
      }
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      if (streamLogger$2.isDebugLogEnabled()) {
          streamLogger$2.logDebug(LoggerManager.resolve(513), request.getFile(), request.getData());
      }
      ...
      try {
        ...
        streamLogger$2.logError(LoggerManager.resolve(514),_e);
        return false;
      }
    ...
    /*private*/ progressEvent: function(phase,responseCallback,completed) {
      ...
      if (responseCallback) {
        ...
        if (streamLogger$2.isDebugLogEnabled()) {
            streamLogger$2.logDebug(LoggerManager.resolve(516), newData);
        }
    ...
    /*private*/ respCompleteEvent: function(phase,responseCallback,connectionEndCallback) {
      ...
      streamLogger$2.logDebug(LoggerManager.resolve(517));
...
var LEGACY_ENCODER = new LegacyEncoder();
  ...
  FormConnection.prototype = {
    ...
    /*public*/ _close: function() {
      streamLogger$3.logDebug(LoggerManager.resolve(518));
      this.isOpen = false;
      this.loadPhase++;
    },
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      try {
        ...
        if (streamLogger$3.isDebugLogEnabled()) {
            streamLogger$3.logDebug(LoggerManager.resolve(519), request.getFile(), request.getData());
        }
        ...
        streamLogger$3.logError(LoggerManager.resolve(520),_e);
        return false;
      }
...
var LEGACY_ENCODER$1 = new LegacyEncoder();
  ...
  */
  ...
  FrameConnection.prototype = {
    ...
    /*public*/ _close: function() {
      streamLogger$4.logDebug(LoggerManager.resolve(521));
    ...
    /*private*/ _loadImpl: function(ph,request,phase,responseCallback,errorCallback) {
      ...
      if (streamLogger$4.isDebugLogEnabled()) {
          streamLogger$4.logDebug(LoggerManager.resolve(522), request.getFile(), request.getData());
      }
      ...
      try {
        ...
        if (frameRef == null) {
            streamLogger$4.logError(LoggerManager.resolve(523));
            return false;
        }
        ...
        */
        ...
        //what could I do? 
        streamLogger$4.logError(LoggerManager.resolve(524),_e);
        return false;
      }
  ...
  AjaxFrameHandler.prototype = {
    ...
    /*private*/ frameTimeout: function(localTimeoutPhase) {
      ...
      if (this.ajaxTimeoutPhase == localTimeoutPhase && !this.isReady()) {
        streamLogger$5.logDebug(LoggerManager.resolve(528));
    ...
    /*private*/ giveUp: function(localTimeoutPhase) {
      ...
      if (this.ajaxTimeoutPhase == localTimeoutPhase && !this.isReady()) {
        streamLogger$5.logDebug(LoggerManager.resolve(529));
    ...
    /*public*/ sendXHR: function(_url,_data,senderObject,extraHeaders) {
      ...
      streamLogger$5.logDebug(LoggerManager.resolve(530),_url);
      ...
      try {
        ...
        streamLogger$5.logDebug(LoggerManager.resolve(531),_e);
      }
  ...
  XHRConnection.prototype = {
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      if (streamLogger$6.isDebugLogEnabled()) {
          streamLogger$6.logDebug(LoggerManager.resolve(532), request.getFile(), request.getData());
      }
    ...
    /*public*/ _close: function() {
      ...
      streamLogger$6.logDebug(LoggerManager.resolve(533));
      ...
      try {
        ...
        streamLogger$6.logError(LoggerManager.resolve(534),_ee);
      }
      this.cleanRef();
    },
    ...
    /*private*/ isHttpStatusOk: function() {
      try {
        ...
        streamLogger$6.logDebug(LoggerManager.resolve(535),_e);
        return false;
      }
    },
    ...
    //not sure if "complete" is really needed (IE6 returns 4 as the other browsers)
      if (this.sender.readyState == 4 || this.sender.readyState == "complete") { 
        ...
        if (streamLogger$6.isDebugLogEnabled()) {
          streamLogger$6.logDebug(LoggerManager.resolve(536),_data);
        }
    ...
    /*private*/ onErrorImpl: function(e) {
      ...
      streamLogger$6.logDebug(LoggerManager.resolve(537));
    ...
    /*private*/ cleanRef: function() {
       //try to remove circular reference (btw since such circle is wrapped 
        ...
        try {
          ...
          streamLogger$6.logDebug(LoggerManager.resolve(538),_e);
        }
        try {
          delete this.sender;
        } catch(_e) {
          streamLogger$6.logDebug(LoggerManager.resolve(539),_e);
        }
    ...
    /*private*/ onReadyStateChangeImpl: function(ph) {
      ...
      if (this.isHttpStatusOk() && this.response) {
        ...
        if (streamLogger$7.isDebugLogEnabled()) {
            streamLogger$7.logDebug(LoggerManager.resolve(541),newData);
        }
      ...
      if (this.sender.readyState == 4) {
        ...
        if (streamLogger$7.isDebugLogEnabled()) {
          streamLogger$7.logDebug(LoggerManager.resolve(542));
        }
...
function retFalse$1() {
    ...
    ConnectionSelector.isGood = function(serverToUse,toTest,isCrossSite,areCookiesRequired,isCrossProtocol,hasExtraHeaders,_list) {
      if (streamLogger$8.isDebugLogEnabled()) {
          streamLogger$8.logDebug(LoggerManager.resolve(543), getClassName(toTest));
      }
      ...
      if (hasExtraHeaders && !toTest.canUseCustomHeaders()) {
        streamLogger$8.logDebug(LoggerManager.resolve(548));
        return false;
      }
      ...
      if (streamLogger$8.isDebugLogEnabled()) {
          streamLogger$8.logDebug(LoggerManager.resolve(550), getClassName(toTest));
      }
    ...
    ConnectionSelector.prototype = {
      ...
      /*public*/ getNext: function(serverToUse,isCrossSite,areCookiesRequired,isCrossProtocol,hasExtraHeaders) {
        if (streamLogger$8.isDebugLogEnabled()) {
            streamLogger$8.logDebug(LoggerManager.resolve(551),
      ...
      /*public*/ _reset: function() {
        streamLogger$8.logDebug(LoggerManager.resolve(552));
        this.point = -1;
      }
    };
...
var names$2 = {
  ...
  SessionHTTP.prototype = {
      ...
      /*protected*/ createSessionExecution: function(ph,reconnectionCause,oldSessionId) {
        ...
        if (Utils.isOffline()) {
          if (maybeOnline <= 0) {
            sessionLogger$3.logDebug(LoggerManager.resolve(553));
        ...
        if (done === null) {
         ...
         this.createSent();
          ...
          sessionLogger$3.logWarn(LoggerManager.resolve(554));
      ...
      /*public*/ recoverSession: function() {
          ...
          if (done === null) {
              ...
              sessionLogger$3.logError(LoggerManager.resolve(555));
              this.onErrorEvent("no_impl_available",{closedOnServer: true,noImplAvailable: true});
          }
      },
...
//        protocolLogger.logDebug(LoggerManager.resolve(556),req);
      ...
      /*private*/ executeConnection: function(oldSession,retryMethod,reconnectionCause,sessionRecovery) {
        ...
        while ((this.chosenConnection || connList.hasNext()) && done === false) {
          ...
          if (done === null) {
            //try later...
            sessionLogger$3.logDebug(LoggerManager.resolve(557));
            ...
            //if (done === true)
            sessionLogger$3.logDebug(LoggerManager.resolve(558));
            connList._reset();
  ...
  SessionWS.prototype = {
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyValue(this.wsPhase,WS_OFF)) {
          sessionLogger$4.logError(LoggerManager.resolve(559));
        }
      //>>excludeEnd("debugExclude");
        ...
        if (ConnectionSelector.isGood(_serverToUse,
            ...
            sessionLogger$4.logDebug(LoggerManager.resolve(560));
      ...
      /*public*/ bindSessionExecution: function(ph,bindCause) {
        ...
        if(this.wsPhase == WS_OFF) {
          ...
          if (!this.wsConn.isConnectedToServer(this.getPushServerAddress())) {
            sessionLogger$4.logWarn(LoggerManager.resolve(561));
            this.wsConn._close();
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$4.logError(LoggerManager.resolve(562),this);
        }
        ...
        if (done === null) {
          ...
          sessionLogger$4.logWarn(LoggerManager.resolve(564));
          this.onSessionGivesUp(this.handlerPhase,"ws.false");
        } else if (!firstSend) { 
          sessionLogger$4.logDebug(LoggerManager.resolve(565));
          this.bindSent();
      ...
      firstSentNotification: function(oPhase) {
        if (this.openWSPhase == oPhase) {
          sessionLogger$4.logDebug(LoggerManager.resolve(566));
          this.bindSent();
          ...
          if (toCheckPhase == this.openWSPhase) {
            ...
            //>>excludeStart("debugExclude", pragmas.debugExclude);  
              if (!ASSERT.verifyDiffValue(this.phase,Session.FIRST_PAUSE)) {
                sessionLogger$4.logError(LoggerManager.resolve(567),this);
              }
            //>>excludeEnd("debugExclude"); 
      ...
      /*protected*/ onErrorEvent: function(reason, args) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          if (!ASSERT.verifyDiffValue(this.wsPhase,WS_OFF)) {
            sessionLogger$4.logError(LoggerManager.resolve(568),this);
          }
        //>>excludeEnd("debugExclude"); 
          if (unableToOpen) {
          ...
          if (this.phase == Session.OFF || this.phase == Session.CREATING || this.phase ==  Session.CREATED) {
            ...
            //NOPPING!
            sessionLogger$4.logDebug(LoggerManager.resolve(569),this);
          ...
          //>>excludeStart("debugExclude", pragmas.debugExclude);  
            if (!ASSERT.verifyNotOk(unableToOpen)) {
              sessionLogger$4.logError(LoggerManager.resolve(571),this);
            }
          //>>excludeEnd("debugExclude");
            
            sessionLogger$4.logDebug(LoggerManager.resolve(572),this);
  ...
  SlowingHandler.prototype = {
    ...
    //>>excludeStart("debugExclude", pragmas.debugExclude);  
      if (!ASSERT.verifyOk(this.session.isReceivingAnswer())) {
        protocolLogger$4.logError(LoggerManager.resolve(573));
      }
    //>>excludeEnd("debugExclude");
  ...
  /////// leave the comment to trigger the heuristic: //////////////////////////////////////////////////////////////////////////
      ...
      if (this.meanElaborationDelay == null) {
        ...
        if (this.meanElaborationDelay < 60) { //the executer runs every 50ms, we can forgive such delay
          ...
          sessionLogger$5.logInfo(LoggerManager.resolve(577));
          return true;
            
        } else {
          sessionLogger$5.logDebug(LoggerManager.resolve(578));
          return false;
  ...
  ControlRequestBatch.prototype = {
              ...
              if (seq != null && prog != null) {
                  for (var i = 0, len = that.queue.length - 1 /* exclude last request */; i < len; i++) {
                      ...
                      if (seq == currentSeq && prog == currentProg) {
                          ...
                          requestsLogger$1.logError(LoggerManager.resolve(579), "seq=", seq, "prog=", prog);
                      }
                  }
              }
          }
    ...
    addRequestToBatch:function(request,preventOverride) {
      ...
      if (requestType == ControlRequest.MESSAGE || requestType == ControlRequest.LOG || requestType == ControlRequest.HEARTBEAT) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          requestsLogger$1.logError(LoggerManager.resolve(580),this);
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        ASSERT.fail();
      //>>excludeEnd("debugExclude");
        requestsLogger$1.logError(LoggerManager.resolve(581),this);
        //should I send an exception?
        return false;
      }
      ...
      requestsLogger$1.logDebug(LoggerManager.resolve(582),this,tKey,request);
      ...
      if (queuedRequest) {
        ...
        if (requestType == ControlRequest.CONSTRAINT 
          ...
          if (queuedRequest.retryingOrHost) {
            ...
            requestsLogger$1.logDebug(LoggerManager.resolve(585));
          ...
          //>>excludeStart("debugExclude", pragmas.debugExclude);  
            if (!ASSERT.verifyNotOk(preventOverride)) {
              requestsLogger$1.logError(LoggerManager.resolve(587),this);
            }
          //>>excludeEnd("debugExclude");
            if (!preventOverride) {
          ...
          if (!preventOverride) {
              requestsLogger$1.logDebug(LoggerManager.resolve(590));
      ...
      requestsLogger$1.logDebug(LoggerManager.resolve(591));
      this.addRequestInternal(tKey,request);
    ...
    /*private*/ removeRequestByIndex: function(_index) {
      if (this.queue.length <= _index) {
        requestsLogger$1.logError(LoggerManager.resolve(592));
        return null;
      }
    ...
    /*private*/ removeRequestByKey: function(tKey) {
      if (!this.keys[tKey]) {
        requestsLogger$1.logError(LoggerManager.resolve(593));
        return null;
      }
...
//>>excludeEnd("debugExclude");
  ...
  ControlConnectionHandler.prototype = {
    ...
    /*public*/ setRequestLimit: function(newLimit) {
      ...
      requestsLogger$2.logDebug(LoggerManager.resolve(594),this);
    },
    ...
    /*public*/ startReverseHeartbeats: function(newInterval, force) {
      if (force) {
          ...
          if (this.grantedReverseHeartbeatInterval == 0 || newInterval < this.grantedReverseHeartbeatInterval) {
              this.currentReverseHeartbeatInterval = newInterval;
              requestsLogger$2.logInfo(LoggerManager.resolve(596),this);
          } else {
    ...
    sendReverseHeartbeat: function(sc) {
      ...
      requestsLogger$2.logDebug(LoggerManager.resolve(598),this);
    ...
    /*public*/ stopReverseHeartbeats: function(force) {
      if (force) {
          ...
          if (this.grantedReverseHeartbeatInterval == 0) {
              requestsLogger$2.logInfo(LoggerManager.resolve(600),this);
              this.currentReverseHeartbeatInterval = 0;
              //do nothing, the next heartbeat will not be sent because of the 0 interval
          } else {
              requestsLogger$2.logInfo(LoggerManager.resolve(601),this);
              this.currentReverseHeartbeatInterval = this.grantedReverseHeartbeatInterval;
          }
      }
    },
    ...
    /*private*/ _close: function() {
      requestsLogger$2.logDebug(LoggerManager.resolve(602));
      if (this.conn) {
        this.conn._close();
      }
    },
    ...
    /*private*/ changeStatus: function(newStatus, caller) {
      ...
      if (requestsLogger$2.isDebugLogEnabled()) {          
          requestsLogger$2.logDebug(LoggerManager.resolve(603), caller + phNames[this.status] + " -> " + phNames[newStatus]);
      }
      this.status = newStatus;
    },

    /*public*/ _reset: function() {
      requestsLogger$2.logDebug(LoggerManager.resolve(604),this);
      this.requestLimit = 0;
      ...
      if (_type !== null && _type !== ControlRequest.DESTROY && _type !== ControlRequest.LOG) {  
        ...
        if (!ASSERT.verifyValue(this.status,_IDLE)) {
          requestsLogger$2.logError(LoggerManager.resolve(606));
        }
        
        //nothing to close
        //lastBatch is already null
        if (!ASSERT.verifyValue(this.lastBatch,null)) {
          requestsLogger$2.logError(LoggerManager.resolve(607));
        }
      //>>excludeEnd("debugExclude");  
    ...
    assignWS: function(wsConn) {
      ...
      if (wsConn) {
        requestsLogger$2.logDebug(LoggerManager.resolve(608),this);
      } else if (this.wsConn) {
    ...
    /*private*/ addRequestExe: function(ph, num, request, _type, related, retryingOrHost) {
      ...
      requestsLogger$2.logInfo(LoggerManager.resolve(610),this,request);
      ...
      if (this.status == _IDLE) {
        ...
        requestsLogger$2.logDebug(LoggerManager.resolve(611),this);
      }
    ...
    /*private*/ dequeue: function(sync,who) {
      if (sync === true) {
        requestsLogger$2.logDebug(LoggerManager.resolve(612),sync,this);
        this.dequeueControlRequests(this.statusPhase,who);
        
      } else {
        requestsLogger$2.logDebug(LoggerManager.resolve(613),sync,this);
    ...
    /*private*/ dequeueControlRequests: function(ph,who) {
      ...
      while(security < SECURITY_LIMIT) {
        ...
        requestsLogger$2.logDebug(LoggerManager.resolve(614),who,this);
        
        var outcome = null;
        if (this.lastBatch != null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(615));
          outcome = this.sendBatch(this.lastBatch);
        } else {
          requestsLogger$2.logDebug(LoggerManager.resolve(616));
          outcome = this.selectAndSendBatch();
        }
        
        if (outcome == REQ_EMPTY) {
          requestsLogger$2.logInfo(LoggerManager.resolve(617));
          ...
          requestsLogger$2.logWarn(LoggerManager.resolve(619));
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(621));
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(622));
                  ...
                  if (seq != null && prog != null) {
                      for (var j = i + 1, jlen = queueToSend.queue.length; j < jlen; j++) {
                          ...
                          if (seq == currentSeq && prog == currentProg) {
                              ...
                              requestsLogger$2.logError(LoggerManager.resolve(623), "seq=", seq, "prog=", prog);
                          }
                      }
                  }
              }
...
//////////////////////////////WS CASE      
      ...
      if (this.wsConn) {
        requestsLogger$2.logDebug(LoggerManager.resolve(626));
        
        var controlRequest = this.customizeRequest(queueToSend,this.wsConn);
        if(controlRequest == null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(627));
          return REQ_EMPTY;
        }
...
//            ASSERT.fail(); //no reason to be here, we have a session id so there should be at least one working connection
          //>>excludeEnd("debugExclude");  
            requestsLogger$2.logWarn(LoggerManager.resolve(628),this.conn);
          ...
          requestsLogger$2.logDebug(LoggerManager.resolve(629),this.conn);
        }      
...
//>>excludeEnd("debugExclude");
        ...
        if (sent === false) {
          requestsLogger$2.logDebug(LoggerManager.resolve(631));
          this.conn = null;
          
        } else if (sent === null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(632));
          //wait and try again
          return SEND_LATER;
...
//////////////////////////////???? CASE 
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        ASSERT.fail();
      //>>excludeEnd("debugExclude");
        requestsLogger$2.logError(LoggerManager.resolve(633));
      }
    ...
    /*private*/ onReadyForNextRequest: function(_responseText,sentPhase) {
      ...
      if (streamLogger$9.isDebugLogEnabled()) {
          streamLogger$9.logDebug(LoggerManager.resolve(634), sentPhase, _responseText);          
      }
      requestsLogger$2.logInfo(LoggerManager.resolve(635),sentPhase);
    ...
    /*private*/ onErrorEvent: function(exc,sentPhase) {
      ...
      requestsLogger$2.logInfo(LoggerManager.resolve(636),this,exc);
  ...
  LastBatch.prototype = {
      ...
      fill: function(queue,lengthLimit,sessionId,cookieHandlingRequired,extraHeaders) {
        ...
        if (lengthLimit > 0 && (nextExpectedLength+expectedFinalLength) > lengthLimit) {
          requestsLogger$2.logWarn(LoggerManager.resolve(637),requestData);
        }
...
var messagesLogger = LoggerManager.getLoggerProxy(Constants.MESSAGES);
  ...
  SendMessageHandler.prototype = {
    ...
    /*public*/ activate: function() {
      messagesLogger.logDebug(LoggerManager.resolve(639));
      if (! this.active) {
    ...
    _send: function(_message, sequence, listener, _timeout) {
      messagesLogger.logDebug(LoggerManager.resolve(640));
      ...
      if (this.active) {
        messagesLogger.logInfo(LoggerManager.resolve(641),query);
    ...
    /*public*/ resend: function(num,bridge) {
      ...
      messagesLogger.logDebug(LoggerManager.resolve(642),query);
    ...
    /*public*/ ack: function(sequence, num) {
      ...
      messagesLogger.logInfo(LoggerManager.resolve(643),sequence,num);
      
      var seqData = this.sequences[sequence];
      if (seqData.messages[num]) {
        if (seqData.messages[num].query != null) {
          messagesLogger.logDebug(LoggerManager.resolve(644));
    ...
    /*private*/ _clear: function(sequence, num) {
      ...
      messagesLogger.logDebug(LoggerManager.resolve(647));
      var seqData = this.sequences[sequence];
    ...
    sentOnNetwork: function(sequence, num) {
      messagesLogger.logDebug(LoggerManager.resolve(648),sequence, num);
    ...
    /*public*/ notifyDenied: function(sequence,_code,msg,num) {
      num = sequence == Constants._UNORDERED_MESSAGES ? this.resolveUnorderedNum(num) : num;
      messagesLogger.logInfo(LoggerManager.resolve(651),sequence, num);
      var listenerInfo = this.getListener(sequence, num);
      if(listenerInfo) {
        var ppHandler = this.pushPagesHandler.getPushPageHandler(listenerInfo.pageNum);
        if (ppHandler) {
    ...
    /*public*/ notifyError: function(sequence,_code,msg,num) {
      num = sequence == Constants._UNORDERED_MESSAGES ? this.resolveUnorderedNum(num) : num;
      messagesLogger.logInfo(LoggerManager.resolve(652),sequence, num);
      var listenerInfo = this.getListener(sequence, num);
      if(listenerInfo) {
  ...
  EvalQueue.prototype = {
    ...
    /*public*/ _enqueue: function(_phase,_data) {
      ...
      if (streamLogger$a.isDebugLogEnabled()) {
        streamLogger$a.logDebug(LoggerManager.resolve(653));
      }
    ...
    */
    /*private*/ dequeueAll: function() {
      ...
      if(streamLogger$a.isDebugLogEnabled()) {
        streamLogger$a.logDebug(LoggerManager.resolve(654),this.equeue.length);
      }
      ...
      while (this.equeue.length > 0) {
        ...
        if (!this.session || !this.session.checkSessionPhase(_el.p)) {
          streamLogger$a.logWarn(LoggerManager.resolve(655), _el.p, _el.d, this.session);
          continue;
        }
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);   
          console.log(_e);
        //>>excludeEnd("debugExclude");
          streamLogger$a.logError(LoggerManager.resolve(656),_e,_el.d);
    ...
    parseText: function(text) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            try {
                ...
                streamLogger$a.logError(LoggerManager.resolve(657), line, e);
    ...
    processUpdate: function(msg) {
        ...
        try {
            ...
            streamLogger$a.logError(LoggerManager.resolve(658), e);
        }
    },
...
var _OFF$1 = 1;
  ...
  var SessionHandler = function(owner,ppHandler,mpnManager) {
    ...
    if (sessionLogger$6.isDebugLogEnabled()) {
        sessionLogger$6.logDebug(LoggerManager.resolve(659), this.objectId);
    }
    this.status = _OFF$1;
    this.statusPhase = 0;
    this.session = null;
  ...
  SessionHandler.prototype = {
      ...
      /*private*/ changeStatus: function(newStatus) {
        if (sessionLogger$6.isDebugLogEnabled()) {
            sessionLogger$6.logDebug(LoggerManager.resolve(660), toStr(this.status), "->", toStr(newStatus));
        }
        this.status = newStatus;
        this.statusPhase++;
      },
...
////////////////////////////////////////////////API CALLS
      ...
      /*public*/ recoverSession: function(ph,switchCause,forced) {
          sessionLogger$6.logDebug(LoggerManager.resolve(661), switchCause);
          if (ph != this.statusPhase) {
              sessionLogger$6.logDebug(LoggerManager.resolve(662));
              return;
          }
      ...
      onSessionGivesUp: function(ph,reason,stop) {
        if (ph != this.statusPhase) {
          ...
          sessionLogger$6.logInfo(LoggerManager.resolve(663));
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(665));
          return;
        }
      ...
      onSlowRequired: function(ph) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(667), toStr(this.status), this.session);
          return;
        }
        this.changeStatus(switchType);
      ...
      createMachine: function(ph,switchCause,forced) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(668), toStr(this.status),toStr(switchType));
      ...
      switchMachine: function(ph,switchCause,forced) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(670), toStr(this.status));
        
        if (!SWITCHING_STATUSES[switchType]) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(671));
          return;
        }
      ...
      slowMachine: function(ph) {
        sessionLogger$6.logInfo(LoggerManager.resolve(672));
      ...
      switchTimeout: function(ph,reason) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(673), toStr(this.status));
        
        if (!SWITCHING_STATUSES[switchType]) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(674));
          return;
        }
...
////////////////////////////////////////////////PUSH EVENTS 
      ...
      /*public*/ onSessionStart: function(requestLimitLength) {
        sessionLogger$6.logInfo(LoggerManager.resolve(675),this.session);
      ...
      /*public*/ onSessionClose: function(ph,noRecoveryScheduled) {
        ...
        sessionLogger$6.logDebug(LoggerManager.resolve(676),this.session);
      ...
      /*public*/ onClearSnapshotEvent: function(args) {
        ...
        if (!ppHandler) {
          //we used to call the deletes here, but when a page disappears its delete are 
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(683),this);
          return;
        }
        
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(684),args);
        }
      ...
      /*public*/ onServerError: function(flag,msg) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(685),flag,msg);
        }
        this.changeStatus(_OFF$1);
      ...
      /*public*/ onTableError: function(tableCode,flag,msg) {
        ...
        if (ppHandler) {
          if (protocolLogger$5.isDebugLogEnabled()) {
            protocolLogger$5.logDebug(LoggerManager.resolve(686),tableCode,flag,msg);
          }
      ...
      /*public*/ onUnsubscription: function(tableCode) {
        ...
        if (ppHandler) {
          if (protocolLogger$5.isDebugLogEnabled()) {
            protocolLogger$5.logDebug(LoggerManager.resolve(688),tableCode);
          }
          ...
          //we used to call the deletes here, but when a page disappears its delete are
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(689),this);
        }
      ...
      /*public*/ onSubscriptionReconf: function(tableCode,ph,frequency) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(690),tableCode,ph,frequency);
        }
        ...
        if (ppHandler != null) {
            ...
            protocolLogger$5.logWarn(LoggerManager.resolve(691), tableCode);
        }
      },
      ...
      /*public*/ onSubscription: function(tableCode,numOfSubscribedItems,numOfSubscribedFields,keyPos,commandPos) {
        ...
        if (!ppHandler) {
          //we used to call the deletes here, but when a page disappears its delete are
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(692),this);
          return;
        }

        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(693),tableCode,numOfSubscribedItems,numOfSubscribedFields,keyPos,commandPos);
        }
      ...
      /*public*/ onMessageAck: function(sequence,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(694),sequence,num);
        }
      ...
      /*public*/ onMessageDiscarded: function(sequence,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(697),sequence,num);
        }
      ...
      /*public*/ onMessageError: function(sequence,flag,msg,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(698),sequence,num,flag,msg);
        }
      ...
      onNewControlLink: function(serverAddress) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(699),serverAddress);
        }
...
////////////////////////////////////////////////CONTROLS
      ...
      /*public*/ sendUnsubscription: function(tableNum,delBody,ppHandler,retrying,tutor) {
          var requestListener = {
                  ...
                  onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                      ...
                      sessionLogger$6.logError(LoggerManager.resolve(700) + printObj$1(delBody) + " caused the error: ", errorCode, errorMsg);
                  }
          };
      ...
      /*public*/ sendSubscriptionChange: function(tableNum,changeBody,tutor) {
          var requestListener = {
                  ...
                  onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                      tutor.discard();
                      sessionLogger$6.logError(LoggerManager.resolve(701) + printObj$1(changeBody) + "] caused the error: " + errorCode + " " + errorMsg);
                  }
          };
      ...
      onFatalError: function(error) {
          sessionLogger$6.logError(LoggerManager.resolve(702), error.stack || error);
          if (this.session) {
...
//THIS CLASS IMPLEMENTS BeanParent
  ...
  LightstreamerEngine.prototype = {
    ...
    doChangeTransport: function() {
        ...
        sessionLogger$7.logInfo(LoggerManager.resolve(704), ft);
        if (ft === null) {
            var fromAPI = true;
    ...
    doConnect: function() {
      sessionLogger$7.logInfo(LoggerManager.resolve(705));
       ...
       forEachChangedField: function(iterator) {
         ...
         for (var i = 0; i < ch.length; i++) {
           ...
           try {
             ...
             actionsLogger$1.logErrorExc(_e,LoggerManager.resolve(706));
           }
       ...
       forEachField: function(iterator) {
         for (var i = 2; i < this.updateValues.length; i++) {
           ...
           try {
             ...
             actionsLogger$1.logErrorExc(_e,LoggerManager.resolve(707));
           }
...
//table status events    
    ...
    //>>excludeEnd("debugExclude");
      ...
      subscriptionsLogger.logInfo(LoggerManager.resolve(709),this);
    ...
    onPause: function() {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(712),this);
    },
    ...
    //>>excludeEnd("debugExclude");
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(713),this);
    ...
    //>>excludeEnd("debugExclude");
      subscriptionsLogger.logInfo(LoggerManager.resolve(714),this);
    ...
    //>>excludeEnd("debugExclude");
      subscriptionsLogger.logInfo(LoggerManager.resolve(715),this);
    ...
    /*private*/ generateRequest: function() {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(716),this);
    ...
    setServerSentMetapushFields: function(commandPos, keyPos) {
      subscriptionsLogger.logDebug(LoggerManager.resolve(717),this,commandPos,keyPos);
...
//////////////////phases, see https://docs.google.com/a/lightstreamer.com/drawings/d/1SsbEMF78re0ASAgByUhy5EQeKWjTG9FUkGR4zMGhtSc/edit?hl=en_US
    ...
    setDataAdapter: function(dataAdapter) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(718),this,dataAdapter);
    },
    ...
    setSelector: function(selector) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(719),this,selector);
    },
    ...
    setRequestedMaxFrequency: function(freq) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(720),this,this.requestedMaxFrequency);
    },
    ...
    setRequestedBufferSize: function(size) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(721),this,this.requestedBufferSize);
    },
    ...
    setRequestedSnapshot: function(required) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(722),this,this.isRequiredSnapshot);
    },
    ...
    setCommandSecondLevelDataAdapter: function(dataAdapter) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(723),this,dataAdapter);
    },
...
/////////////METAPUSH    
    ...
    organizeMPUpdate: function(args,_item,fromMultison) {
      ...
      if ((typeof args[this.keyCode + 1] == "undefined")||(typeof args[this.commandCode + 1] == "undefined")) {
        subscriptionsLogger.logWarn(LoggerManager.resolve(724));
        return null;
      }
...
// END_NODE_JSDOC_EXCLUDE
      enableSharing: function(sharing) {
        ...
        if (userAgent != null && (userAgent.indexOf("ucbrowser") != -1 || userAgent.indexOf("ubrowser") != -1)) {
            sharingLogger.logInfo(LoggerManager.resolve(725));
            return;
        }
      ...
      enableSharingExec: function(sharing,ph) {
        ...
        if (sharing && ! sharing.isPossible()) {
            sharingLogger.logInfo(LoggerManager.resolve(726));
        }
        if (sharing && sharing.isPossible()) {
...
//>>excludeStart("debugExclude", pragmas.debugExclude);
        if (!this.sharing) {
          ASSERT.fail();
          actionsLogger.logError(LoggerManager.resolve(728));
          return;
        }
//>>excludeEnd("debugExclude");

        actionsLogger.logInfo(LoggerManager.resolve(729));
...
END_NODE_JSDOC_EXCLUDE
       ...
       */
      disconnect: function() {
        actionsLogger.logInfo(LoggerManager.resolve(732));
      ...
      asynchDisconnect: function() {
        ...
        actionsLogger.logDebug(LoggerManager.resolve(733));
